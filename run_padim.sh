...
for product_id in 'QFN-3X3-16L'  '1101QFN-40L' '0713DFN-2X3-8L'  "0713DFN-2X3-8L"  "1101QFN-40L" "1129QFN-4X4-24L" "DFN-5X6-8L"  "0420QFN-5X6-8L" "0708DFN-8L" 
do
  CUDA_VISIBLE_DEVICES=1,2,3,0  python3  main.py  --train_num_samples  0  --test_num_samples 0  --product_class $product_id --threshold_coefficient $threshold_coefficient  --gaussian_blur_kernel_size 5 --save_path /git/PaDiM-master/kangqiang_result 2>&1 |tee Logs/$timestamp.log
done
